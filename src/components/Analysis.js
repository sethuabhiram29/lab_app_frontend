...
function Analysis() {
  ...
  return (
    <Box sx={{ minHeight: '100vh', background: 'url(/analysis_bg_light.png) center/cover no-repeat fixed', pb: 8 }}>
      <Container maxWidth="lg" sx={{ position: 'relative', zIndex: 1, pt: { xs: 4, md: 8 } }}>
        ...
        <Box sx={{ 
          borderRadius: '32px', background: 'linear-gradient(135deg, rgba(255,255,255,0.45) 0%, rgba(255,255,255,0.15) 100%)', 
          backdropFilter: 'blur(24px)', boxShadow: '0 24px 64px rgba(0,0,0,0.06), inset 0 1px 0 rgba(255,255,255,0.8)', 
          border: '1px solid rgba(255,255,255,0.6)', overflow: 'hidden', p: { xs: 3, sm: 5 } 
        }}>
        ...
        {/* Mode Toggle */}
        <Box sx={{ mb: 4, display: 'inline-flex', p: 0.5, background: 'rgba(255,255,255,0.4)', borderRadius: 'var(--radius-xl)', border: '1px solid rgba(255,255,255,0.6)', position: 'relative' }}>
          {['doctor', 'agent'].map(m => (
            <Box
              key={m}
              onClick={() => setMode(m)}
          ...
          <Box sx={{ flex: 1, width: '100%' }}>
            {mode === 'doctor' ? (
              <Autocomplete
                ...
                renderInput={params => <TextField {...params} label="Select Doctor" fullWidth sx={glassFieldSx} />}
              />
            ) : (
              <Autocomplete
                options={agents}
                ...
                renderInput={params => <TextField {...params} label="Select Agent" fullWidth sx={glassFieldSx} />}
              />
            )}
          </Box>
          <Box sx={{ flex: 1, width: '100%' }}>
        ...
        {patients.length > 0 && (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.2 }}>
            <Box sx={{ display: 'flex', gap: 3, mb: 5, mt: 4, flexDirection: { xs: 'column', sm: 'row' } }}>
              <Box sx={{ flex: 1, p: 3, borderRadius: 'var(--radius-2xl)', background: 'linear-gradient(135deg, rgba(255,255,255,0.4) 0%, rgba(255,255,255,0.1) 100%)', border: '1px solid rgba(255,255,255,0.6)', backdropFilter: 'blur(24px)', position: 'relative', overflow: 'hidden', boxShadow: '0 8px 32px rgba(0,0,0,0.04)' }}>
                <Box sx={{ position: 'absolute', top: -20, right: -20, width: 100, height: 100, background: 'rgba(34,197,94,0.15)', borderRadius: '50%', filter: 'blur(20px)' }} />
              ...
              <Box sx={{ flex: 1, p: 3, borderRadius: 'var(--radius-2xl)', background: 'linear-gradient(135deg, rgba(255,255,255,0.4) 0%, rgba(255,255,255,0.1) 100%)', border: '1px solid rgba(255,255,255,0.6)', backdropFilter: 'blur(24px)', position: 'relative', overflow: 'hidden', boxShadow: '0 8px 32px rgba(0,0,0,0.04)' }}>
                <Box sx={{ position: 'absolute', top: -20, right: -20, width: 100, height: 100, background: 'rgba(239,68,68,0.15)', borderRadius: '50%', filter: 'blur(20px)' }} />
              ...
              <Box sx={{ flex: 1, p: 3, borderRadius: 'var(--radius-2xl)', background: 'linear-gradient(135deg, rgba(255,255,255,0.4) 0%, rgba(255,255,255,0.1) 100%)', border: '1px solid rgba(255,255,255,0.6)', backdropFilter: 'blur(24px)', position: 'relative', overflow: 'hidden', boxShadow: '0 8px 32px rgba(0,0,0,0.04)' }}>
                <Box sx={{ position: 'absolute', top: -20, right: -20, width: 100, height: 100, background: 'rgba(15,110,86,0.15)', borderRadius: '50%', filter: 'blur(20px)' }} />
            ...
            <TableContainer sx={{ background: 'rgba(255,255,255,0.4)', backdropFilter: 'blur(10px)', borderRadius: 'var(--radius-xl)', border: '1px solid rgba(255,255,255,0.8)', overflow: 'hidden' }}>
              <Table>
                <TableHead sx={{ background: 'rgba(255,255,255,0.3)' }}>
                  <TableRow>
            ...
            <Box sx={{ mt: 5 }}>
              ...
              <TableContainer sx={{ background: 'rgba(255,255,255,0.4)', backdropFilter: 'blur(10px)', maxWidth: 450, borderRadius: 'var(--radius-xl)', border: '1px solid rgba(255,255,255,0.8)', overflow: 'hidden' }}>
                <Table>
                  <TableHead sx={{ background: 'rgba(255,255,255,0.3)' }}>
                    <TableRow>
